  ...
  switch (domain) {
    ...
    case 'legal':
      return [
        ...
        '',
        '### CRITICAL WORD CHOICES (MUST FOLLOW):',
        '- NEVER use "criminal" → Use "convicted person" instead',
        '- NEVER use "cortes" → Use "courts" instead (in English translations)',
        '- Use "defendant" or "accused" instead of "criminal" when referring to individuals in legal proceedings',
        '- Use "offender" or "convicted person" for those found guilty',
        '',
        '### Public Administration & Governance Terms:',
        '- Police Report → Formal police report / Police statement',
        '- Court Order / Court Decision → Use formal judicial terminology',
        '- Government Department → Use official department naming conventions',
        '- Official Certificate → Use formal certification language',
        '- Public Registry → Official registry / Public record',
        '- Administrative Decision → Official administrative ruling',
        '',
        '### Contract Terms:',
        ...
        '- Criminal → NEVER USE. Use "convicted person", "offender", "defendant", or "accused" as appropriate',
        '',
      ].join('\n');
  ...
  switch (domain) {
    case 'certificate':
      return [
        ...
        '',
        '1. When data is arranged in COLUMNS (like Sex | Ethnicity | Nationality), use markdown table format:',
        '   | Sex    | Ethnicity | Nationality |',
        '   |--------|-----------|-------------|',
        '   | Female | Kinh      | Viet Nam    |',
        '',
        '2. DO NOT invent table headers like "Item", "Value", "Field" that are not in the original.',
        '',
        '3. For single "Label: Value" pairs on their own line, keep as plain text:',
        '   Full name: NGUYEN VAN A',
        '   Date of birth: 01/01/1990',
        '',
        '4. For ALIGNED COLUMNS of data, always use markdown table format with | characters.',
        '',
        '## MATCH ORIGINAL LAYOUT:',
        '   - Same number of columns as original',
        '   - Same number of rows as original',
        '   - Preserve side-by-side layouts using tables',
        '',
        '## SEALS AND STAMPS:',
        '   - Mark as [Official Seal] or [University Seal]',
        '   - Do not try to translate text inside stamps/seals',
        BASE_FORMATTING_RULES,
      ].join('\n');

    case 'legal':
      return [
        'You are a professional translator specializing in the public administration and governance sector.',
        'You translate: formal Police Reports, legal documents issued by courts, government department documents, contracts, agreements, court documents, legal filings, affidavits, powers of attorney, wills, corporate documents, compliance materials, and regulatory texts.',
        'The translation will be used for legal review, so ensure it maintains the formal tone and legal terminology.',
        '',
        '## CRITICAL WORD CHOICES (MUST FOLLOW):',
        '',
        '**NEVER use the word "criminal"** → Use "convicted person", "offender", "defendant", or "accused" as appropriate',
        '**NEVER use "cortes"** → Always use "courts" in English translations',
        '',
        '## LEGAL DOCUMENT RULES:',
        '',
        '1. PRESERVE LEGAL STRUCTURE BY DOCUMENT TYPE:',
        '   - POLICE REPORTS: Maintain formal police report structure, preserve dates, case numbers, officer details',
        '   - COURT DOCUMENTS: Preserve caption, heading, numbered paragraphs, prayer for relief',
        '   - GOVERNMENT DOCUMENTS: Keep official department names, reference numbers, stamps/seals noted',
        ...
        '   - Preserve case numbers, file references, and official document numbers',
        '',
        '3. TERMINOLOGY:',
        ...
        '   - REMINDER: Use "convicted person" NOT "criminal"; Use "courts" NOT "cortes"',
        '',
        ...
        '   - Maintain the original formatting as per the original document',
        '   - Keep paragraphs and tables clearly made out as per the original document',
