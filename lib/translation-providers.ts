  ...
  switch (domain) {
    case 'certificate':
      return [
        ...
        '',
        '1. ONLY create tables if the original document has a table structure (grid/rows/columns).',
        '2. DO NOT convert form fields or "Label: Value" text into tables.',
        '3. DO NOT add table headers like "Item", "Value", "Field" that are not in the original.',
        '',
